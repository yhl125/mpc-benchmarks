...
import { idlFactory } from './ecdsa_example_motoko0.did.js';
export { idlFactory } from './ecdsa_example_motoko0.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ECDSA_EXAMPLE_MOTOKO0;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ecdsa_example_motoko0.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ecdsa_example_motoko0 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ecdsa_example_motoko0.did.js")._SERVICE>}
 */
export const ecdsa_example_motoko0 = createActor(canisterId);
