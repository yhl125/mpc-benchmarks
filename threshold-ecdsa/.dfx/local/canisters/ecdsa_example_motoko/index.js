...
import { idlFactory } from './ecdsa_example_motoko.did.js';
export { idlFactory } from './ecdsa_example_motoko.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ECDSA_EXAMPLE_MOTOKO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ecdsa_example_motoko.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ecdsa_example_motoko canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ecdsa_example_motoko.did.js")._SERVICE>}
 */
export const ecdsa_example_motoko = createActor(canisterId);
